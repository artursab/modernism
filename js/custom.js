...
$(window).ready(function() {
	...
	$.vegas('slideshow', {
	  backgrounds:[
		{ src:'images/bg-slider/6.png', fade:1000 },
		{ src:'images/bg-slider/3.png', fade:1000 },
		{ src:'images/bg-slider/5.png', fade:1000 }
	  ]
	})();
});
...
$(document).ready(function() {
	...
	$('#subscription-form').ajaxChimp({
		...
		url: 'https://artursab.github.io/modernism/' /* custom URL inside '' */
	});
